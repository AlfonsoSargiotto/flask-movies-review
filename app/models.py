...
class Movie(db.Model):
    ...
    director_id = db.Column(
        db.Integer(), db.ForeignKey("director.id"), default=1, nullable=False
    )
    category_id = db.Column(
        db.Integer(), db.ForeignKey("category.id"), default=1, nullable=False
    )
